...
The Digital Omnibus on AI was published in the Official Journal as Regulation (EU) 2026/1744 on 24 July 2026 and entered into force on 27 July 2026. Since then the amended dates are the binding law: Annex III high-risk obligations apply from 2 December 2027, Annex I obligations from 2 August 2028, and providers of generative systems placed on the market before 2 August 2026 have until 2 December 2026 to meet the Article 50(2) marking duty. The original dates stay in every record as historical and audit context. A classification recorded before entry into force was assessed under the original calendar, and an audit record that cannot show which calendar it was assessed under is not much of an audit record. So every obligation is reported with both dates and a status flag, the legal status is stated on every output, and a reader can see where each deadline sits and where it moved from. Classification guides written before mid-2026 mostly show the superseded calendar; this engine shows both and says which one binds.
